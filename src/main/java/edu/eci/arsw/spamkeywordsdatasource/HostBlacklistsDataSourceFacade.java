...
public class HostBlacklistsDataSourceFacade {
    ...
    //mvn exec:java -Dexec.mainClass="edu.eci.arsw.spamkeywordsdatasource.HostBlacklistsDataSourceFacade" -Dthreadsinfo=true

    static ConcurrentHashMap<Tuple<Integer,String>,Object> blistoccurrences=new ConcurrentHashMap<>();

    static{
        Object anyObject=new Object();
        //to be found by a single thread
        blistoccurrences.put(new Tuple<Integer,String>(23,"200.24.34.55"), anyObject);
        blistoccurrences.put(new Tuple<Integer,String>(50,"200.24.34.55"), anyObject);
        blistoccurrences.put(new Tuple<Integer,String>(200,"200.24.34.55"), anyObject);
        blistoccurrences.put(new Tuple<Integer,String>(1000,"200.24.34.55"), anyObject);
        blistoccurrences.put(new Tuple<Integer,String>(500,"200.24.34.55"), anyObject);

        //to be found through all threads
        blistoccurrences.put(new Tuple<Integer,String>(29,"202.24.34.55"), anyObject);
        blistoccurrences.put(new Tuple<Integer,String>(10034,"202.24.34.55"), anyObject);
        blistoccurrences.put(new Tuple<Integer,String>(20200,"202.24.34.55"), anyObject);
        blistoccurrences.put(new Tuple<Integer,String>(31000,"202.24.34.55"), anyObject);
        blistoccurrences.put(new Tuple<Integer,String>(70500,"202.24.34.55"), anyObject);

        //to be found through all threads
        blistoccurrences.put(new Tuple<Integer,String>(39,"202.24.34.54"), anyObject);
        blistoccurrences.put(new Tuple<Integer,String>(10134,"202.24.34.54"), anyObject);
        blistoccurrences.put(new Tuple<Integer,String>(20300,"202.24.34.54"), anyObject);
        blistoccurrences.put(new Tuple<Integer,String>(70210,"202.24.34.54"), anyObject);
    ...
    public boolean isInBlackListServer(int serverNumber,String ip){
        ...
        threadHits.putIfAbsent(Thread.currentThread().getName(), 0);
        threadHits.compute(Thread.currentThread().getName(), (k, v) -> v + 1);
        ...
        return blistoccurrences.containsKey(new Tuple<Integer,String>(serverNumber,ip));
